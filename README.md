...
[![Version](https://img.shields.io/badge/version-0.3.2-7C6AF7?style=flat-square)](https://github.com/bramuchile/stride/releases)
...
| Installer | Format |
|-----------|--------|
| [`Stride_0.3.2_x64-setup.exe`](https://github.com/bramuchile/stride/releases/download/v0.3.2/Stride_0.3.2_x64-setup.exe) | NSIS installer |
| [`Stride_0.3.2_x64.msi`](https://github.com/bramuchile/stride/releases/download/v0.3.2/Stride_0.3.2_x64_en-US.msi) | MSI package |
